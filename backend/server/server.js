...
// ── Connect to MongoDB ────────────────────────────────────────
// In serverless environments, we kick off database connection synchronously
// in the background. Mongoose automatically handles queuing requests until connected.
connectDB();
...
// ── Start server (conditional for Vercel Serverless Functions) ─
let server;
